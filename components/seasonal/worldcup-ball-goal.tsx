      ...
      {enabled ? (
        <>
          ...
          <div className="wc-stage" ref={layerRef}>
            ...
            >
              {/* 축구공 — Twemoji(트위터 오픈소스 이모지, CC-BY 4.0)의 ⚽(26bd) 솔리드 SVG를 인라인.
                  꽉 찬 원이라 투명/뚫림 없음. ballRoll(굴림·커브 스핀)이 그대로 무늬를 돌린다. */}
              <svg className="wc-ball-svg" viewBox="0 0 36 36" aria-hidden="true">
