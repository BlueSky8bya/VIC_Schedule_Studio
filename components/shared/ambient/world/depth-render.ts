...
const scopes = new WeakMap<CanvasRenderingContext2D, { offsets: DepthOffsets; tier: DepthTier; current: { x: number; y: number }; owner?: object }>();
...
export function drawDepthGround(g: CanvasRenderingContext2D, source: HTMLCanvasElement, w: number, h: number, far = false, vertical: "both" | "bottom" | "none" = far ? "none" : "both") {
