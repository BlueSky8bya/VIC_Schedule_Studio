...
// 안 바뀐다 — '랜덤'이되 세계는 하나다. 하루는 **세 마디**로 굴리고(2026-09-07 소유자, PLAN-20260907-006 — 경계 시각은
// 날짜 시드 랜덤이되 각 마디 ≥ 4시간; 비가 그친 뒤 달팽이·지렁이가 나오는 창을 만들기 위해 '직전 마디' 날씨도 준다).
// 장면은 f.weather로 비 파문·눈 세기·돌풍 빈도·비 뒤 생물을 고른다.
//
