...
const PHASE1: readonly ArtSlot[] = [
  ...
  { id: "shrub-winter", variants: 2, nameKo: "관목(겨울)", nameEn: "Shrub, winter", category: "tree", seasons: ["winter"], view: "stand", px: [62, 66], brief: "잔가지만 남은 둥근 관목 위에 눈이 소복이 덮였다.", acnhRef: "울타리 관목(겨울)", now: "procedural", phase: 1 },
  // 풀·꽃
