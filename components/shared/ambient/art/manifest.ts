...
const PHASE1: readonly ArtSlot[] = [
  ...
  { id: "tree-pine", nameKo: "소나무", nameEn: "Pine", category: "tree", seasons: ["spring", "summer", "autumn"], view: "stand", px: [92, 168], brief: "동물의 숲 침엽수처럼 단순하게: **톱니 원뿔 3단**(아래가 가장 넓고 위로 갈수록 좁다)이 짧고 굵은 회갈색 줄기 위에 얹힌다. 색은 짙은 청록 초록 3톤(밝은 면은 왼쪽 위, 그늘은 오른쪽 아래), 솔잎 낱개는 그리지 않는다. 참나무보다 **좁고 키가 크다**.", acnhRef: "침엽수", now: "none", phase: 1 },
  { id: "tree-pine-autumn", nameKo: "소나무(가을)", nameEn: "Pine, autumn", category: "tree", seasons: ["autumn"], view: "stand", px: [92, 168], brief: "봄·여름 소나무와 **같은 실루엣·같은 줄기**. 잎만 채도를 낮춘 올리브~암녹으로(가을 갈색 지면 위에서 민트빛 초록은 붙여넣은 것처럼 뜬다).", acnhRef: "침엽수(가을)", now: "none", phase: 1 },
  { id: "tree-pine-winter", nameKo: "소나무(겨울)", nameEn: "Pine, winter", category: "tree", seasons: ["winter"], view: "stand", px: [92, 168], brief: "같은 실루엣·같은 줄기. 잎은 더 어둡고 채도가 낮으며, 각 단의 **윗면에만** 눈이 한 겹 얹힌다(아래 그늘은 옅은 청회색).", acnhRef: "침엽수(겨울)", now: "none", phase: 1 },
  ...
  { id: "shrub-spring", nameKo: "관목(봄)", nameEn: "Shrub, spring", category: "tree", seasons: ["spring"], view: "stand", px: [62, 66], brief: "허리 높이의 둥근 관목, 연둣빛 새잎, 작은 흰 꽃 몇 송이.", acnhRef: "울타리 관목(진달래류)", now: "none", phase: 1 },
  { id: "shrub-summer", nameKo: "관목(여름)", nameEn: "Shrub, summer", category: "tree", seasons: ["summer"], view: "stand", px: [62, 66], brief: "짙은 초록 둥근 관목, 잎이 빽빽하다.", acnhRef: "울타리 관목(수국은 파랑 대신 연보라)", now: "none", phase: 1 },
  { id: "shrub-autumn", nameKo: "관목(가을)", nameEn: "Shrub, autumn", category: "tree", seasons: ["autumn"], view: "stand", px: [62, 66], brief: "갈색·와인으로 물든 둥근 관목, 잎이 성기다.", acnhRef: "울타리 관목(가을)", now: "none", phase: 1 },
  { id: "shrub-winter", nameKo: "관목(겨울)", nameEn: "Shrub, winter", category: "tree", seasons: ["winter"], view: "stand", px: [62, 66], brief: "잔가지만 남은 둥근 관목 위에 눈이 소복이 덮였다.", acnhRef: "울타리 관목(겨울)", now: "none", phase: 1 },
  // 풀·꽃
