...
const PHASE1: readonly ArtSlot[] = [
  ...
  { id: "reed", nameKo: "갈대", nameEn: "Reed", category: "plant", seasons: ["summer"], view: "stand", px: [30, 70], variants: 2, brief: "물가에 선 갈대 서너 대 — 긴 잎과 갈색 이삭, 살짝 휘었다. 변형 2개.", acnhRef: "물가 풀", now: "none", phase: 1 },
  // 물
  ...
  { id: "rock", nameKo: "바위", nameEn: "Rock", category: "ground", seasons: ALL, view: "stand", px: [40, 30], variants: 2, brief: "무릎 높이의 둥글둥글한 바위, 이끼가 조금 앉았다. 변형 2개.", acnhRef: "바위", now: "none", phase: 1 },
