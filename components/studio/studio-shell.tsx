    ...
    >
      ...
      {modal ? (
        <div
          className={
            modal === "tags"
              ? "modal-backdrop modal-backdrop-tags"
              : modal === "members"
                ? "modal-backdrop modal-backdrop-members"
                : "modal-backdrop"
          }
        ...
        >
          <div
            className={`modal-card ${modal === "tags" || modal === "members" || modal === "notice" || modal === "developer" || modal === "dayVisit" ? "modal-card-wide" : ""}${modal === "tags" ? " modal-card-tags" : ""}${modal === "members" ? " modal-card-members" : ""}`}
            aria-modal="true"
            role="dialog"
