...
> **Accepted(2026-09-08, 구현 완료)**: [PLAN-20260908-010 — 아트 보드 목록 재작성](PLAN-20260908-010-art-board-rebuild.md) —
> 목록이 답할 질문은 **"무엇이 남았나"** 하나. 규격·브리프·프롬프트는 자리 상세로 보냈다. 첫 카드 y 590 → 316, 상시 칩 40+ → 4.
...
> 먼바다·깊은 바다, 방향 = 오행) · 방향키/WASD/스와이프/쉐브론/미니맵 카메라 620ms · 시청자도 감상 · **만난 생물 → 도감(로그인 기록)**.
> 소유자 결정 ⓪~④ 확정(§8). 순서: **P0 축척+시점 → P1 세계·카메라 → P2 생물·도감(PLAN-003 Phase B 흡수) → P3 아트**.
>
