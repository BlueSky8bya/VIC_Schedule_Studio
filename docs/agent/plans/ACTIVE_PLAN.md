...
> **Proposed(다음 큰 공사, 2026-09-04 밤)**: [PLAN-20260904-004 — 바이옴 세계(Biome World)](PLAN-20260904-004-biome-world.md) —
> 동물의 숲 축척(타일 64px, 최대:최소 ≤ 12 — 낙엽·발자국 축소, 나무 소폭 확대) · **기본 화면 = 초원**(여름 억지 기슭 폐기, 물은
> 연못·바다 바이옴으로) · 십자 다섯 화면(★초원 · 北 민물 · 東 숲 · 西 들판·언덕 · 南 바닷가, 방향 = 오행) · 방향키/스와이프/쉐브론/미니맵으로
> 카메라 620ms 이동 · 생물은 서식지 표로 배치(바다 8종 신규). **소유자 결정 5건 대기(§8)**; P0 축척은 결정과 무관하게 바로 가능.
> PLAN-003 Phase B(에이전트)는 이 계획의 P2로 흡수.
>
> 이전: [PLAN-20260904-003 — 계절 연대기(Chronicle)](PLAN-20260904-003-ambient-chronicle.md) — 생물 10배·
> 동물의 숲식 희귀도·달력 시간을 잇는 연대기(도토리 → 싹 → 나무·눈사람)·층 무대(잡초·관목·나무·대기 원근)·에이전트 프레임워크.
> 조사 완료 → **소유자 결정 7건 확정(2026-09-04 밤: 여섯 띠 · 전설 순수 확률 · 도감은 로그인만 · 공유 없음 · 날씨 랜덤(날짜 시드) ·
> 우선 20종 · 채도 균형) → Phase A(기반: world/*, 엔진 Frame 확장, 연대기 렌더) 착수.**
