...
- **숲 VOD 아카이브(PLAN-20260831-001) — Phase 1 완료, Phase 2 대기(2026-08-31)**:
  ...
  **귀속 규칙 2건(2026-08-31 사용자 결정)**: ① 30분 체인 — 직전 VOD 종료와 간격 30분 이내면
  ...
  ⑤ **과거 일정 카드 생성 v2**(CHG-20260831-002): ≤2025-12 일정 없던 153일에 168건 —
  정제 제목이 다르면 별도 일정(분위기 분리) + 제목 키워드 태그 자동 부여(대표=첫 콘텐츠 매치,
  327건, 무태그 0). 롤백 = `--purge db/backfills/2026-08-31-history-events.json`.
