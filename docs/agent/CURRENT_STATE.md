...
2026-09-17 UI unification shipped ([ADR-0025](decisions/ADR-0025-side-panel-unification.md)). VOD window redesign shipped same day: one stage + 부 tabs, title in header, ? key help, gold current chapter, horizontal timeline strip, corner fold/jump, rail = side-panel width/side, ↑↓ [ ] Shift+←→ C keys, auto-next.
