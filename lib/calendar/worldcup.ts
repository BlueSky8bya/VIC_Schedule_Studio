...
// 4강부터는 하루 1경기라 실제 대진·스코어를 함께 표기한다. 조화(통일·균형·리듬)를 위해 헤더(name)엔
// 짧은 라운드명만 두고(다른 날 헤더와 같은 1줄 pill), 대진·스코어(sub)는 칸 본문에 별도 칩으로
// 내린다 — 예전엔 긴 'name 팀 스코어 팀'을 날짜숫자 옆 헤더에 욱여넣어 그 칸만 2줄로 커지고
// 우상단이 구겨져 그리드 리듬이 깨졌다. 결승 스페인 1-0 아르헨티나(페란 토레스 106' 연장골)로 우승.
const STAGE_MARKS: Record<string, { name: string; sub?: string }> = {
  "2026-06-12": { name: "⚽ 월드컵 개막" },
  "2026-06-29": { name: "⚽ 32강" },
  "2026-07-05": { name: "⚽ 16강" },
  "2026-07-10": { name: "⚽ 8강" },
  "2026-07-15": { name: "⚽ 4강", sub: "프랑스 0-2 스페인" },
  "2026-07-16": { name: "⚽ 4강", sub: "잉글랜드 1-2 아르헨티나" },
  "2026-07-19": { name: "⚽ 3·4위전", sub: "잉글랜드 6-4 프랑스" },
  "2026-07-20": { name: "🏆 결승", sub: "스페인 1-0 아르헨티나" }
};
