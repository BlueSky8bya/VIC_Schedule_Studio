...
// 아르헨티나(페란 토레스 106' 연장골)로 스페인 우승. 국가명은 공식 풀네임으로 둔다 — 포스터
// 7열 그리드의 날짜칸 마크(.day-mark)가 길면 잘리던 문제는 그 칸 마크를 '2줄 wrap' 허용으로
// 바꿔(줄임말 대신) 해결한다(public-poster.css .day-mark). 다른 마크(4강, 3·4위전)와 톤 통일 위해
// 결승에도 '월드컵' 군더더기는 빼고 '결승'만 둔다(🏆로 이미 결승임이 드러남).
