...
// 토너먼트 단계 경계일 — FIFA 공개(현지시각) 일정을 KST로 환산(현지 오후·저녁 킥오프 → +1일).
// 48개국이라 32강(Round of 32)이 있다. (현지 → KST) 개막 6/11→6/12, 32강 6/28→6/29, 16강 7/4→7/5,
// 8강 7/9→7/10, 4강 7/14→7/15, 3·4위전 7/18→7/19, 결승 7/19→7/20.
