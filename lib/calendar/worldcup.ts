...
// 표기 길이 주의: 포스터 7열 그리드의 날짜칸 .day-mark은 nowrap+ellipsis라 길면 뒤 국가명이 잘린다
// (칸 마크 여유 ≈215px). 그래서 결승에서 'FIFA/월드컵' 군더더기 단어를 빼고, 유일하게 5글자인
// '아르헨티나'만 관용 약어 '아르헨'으로 줄여 한 줄에 들어오게 한다(스페인·프랑스·잉글랜드는 그대로).
const STAGE_MARKS: Record<string, string> = {
  ...
  "2026-07-16": "⚽ 4강 잉글랜드 1-2 아르헨",
  "2026-07-19": "⚽ 3·4위전 잉글랜드 6-4 프랑스",
  "2026-07-20": "🏆 결승 스페인 1-0 아르헨"
};
