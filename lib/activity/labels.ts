...
export const ACT: Record<string, TargetLabel> = {
  ...
  "search-rail-jump": { name: "검색 날짜 레일", area: "시청자 화면", hint: "오른쪽 점을 눌러 그 날짜로" },
  "search-scroll-top": { name: "검색 맨 위로", area: "시청자 화면" },
  ...
  "avatar-ctl-toggle": { name: "패널 자리 바꾸기", area: "시청자 화면", hint: "하단 알약 ⇤ ⇥ — 편집실·미리보기 공용" },
  ...
  "역할 권한 보기": { name: "모바일 설정 열기", area: "편집실", hint: "역할 이름 옆 톱니 버튼" },
