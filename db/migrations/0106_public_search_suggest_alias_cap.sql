-- 0106: 검색어 제안 — 별칭은 실제로 쓰이는 것만(제목·챕터·채팅 3방송 이상), 사람당 상위 3개. 0105 suggest 재정의.
-- 소유자(2026-09-18): "'불시' 같은 마이너 별명까지 다 나오면 오히려 마이너스 — 시청자들이 자주 쓰는 것만".
-- 멱등. 적용: node scripts/apply-db.mjs db/migrations/0106_public_search_suggest_alias_cap.sql
