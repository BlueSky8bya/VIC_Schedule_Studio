-- 0109: 검색어 제안 성능 — 0108의 굴절형 판정(행마다 서브쿼리, O(n²), 실측 37초)을 해시 조인 CTE로, scored는 materialized.
-- 멱등. 적용: node scripts/apply-db.mjs db/migrations/0109_public_search_suggest_perf.sql
