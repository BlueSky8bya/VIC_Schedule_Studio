...
| `(studio)/studio/trusted-members` | 신뢰 멤버(매니저) 관리 |
...
| `api/studio-write` | 편집 낙관적 쓰기(keepalive) | 떠나도 안 잃게 |
| `api/unlock-private-layer` | 패스코드 검증(최초공개 게이트)·비공개 unlock | 구글 로그인+패스코드 |
